  ...
  return (
    <div className="container mx-auto max-w-4xl p-6 space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-default-500">Manage your account and explore features</p>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 bg-default-50 dark:bg-default-100 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-default-500">Welcome to the platform!</p>
              </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-default-50 dark:bg-default-100 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-default-500">Your profile is now ready</p>
              </div>
